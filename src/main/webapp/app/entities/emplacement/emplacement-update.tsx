...
export const EmplacementUpdate = (props: IEmplacementUpdateProps) => {
  ...
  const { emplacementEntity, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="projetBibliothequeApp.emplacement.home.createOrEditLabel">Create or edit a Emplacement</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : emplacementEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
              ...
              <AvGroup>
                <Label id="idEmplacementLabel" for="emplacement-idEmplacement">
                  Id Emplacement
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="nomEmplacementLabel" for="emplacement-nomEmplacement">
                  Nom Emplacement
                </Label>
                <AvField id="emplacement-nomEmplacement" type="text" name="nomEmplacement" />
              </AvGroup>
              <Button tag={Link} id="cancel-save" to="/emplacement" replace color="info">
