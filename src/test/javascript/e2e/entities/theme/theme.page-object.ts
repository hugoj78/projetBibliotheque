...
export class ThemeDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('projetBibliothequeApp.theme.delete.question'));
...
export default class ThemeComponentsPage {
  ...
  async deleteTheme() {
    ...
    expect(await themeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/projetBibliothequeApp.theme.delete.question/);
