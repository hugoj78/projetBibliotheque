...
public class ThemeResourceIT {
    ...
    private static final UUID DEFAULT_ID_THEME = UUID.randomUUID();
    private static final UUID UPDATED_ID_THEME = UUID.randomUUID();
    ...
    public void createTheme() throws Exception {
        ...
        assertThat(testTheme.getIdTheme()).isEqualTo(DEFAULT_ID_THEME);
    ...
    @Test
    @Transactional
    public void checkIdThemeIsRequired() throws Exception {
    ...
    public void getAllThemes() throws Exception {
        ...
        restThemeMockMvc.perform(get("/api/themes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].idTheme").value(hasItem(DEFAULT_ID_THEME.toString())))
    ...
    public void getTheme() throws Exception {
        ...
        restThemeMockMvc.perform(get("/api/themes/{id}", theme.getId()))
            ...
            .andExpect(jsonPath("$.idTheme").value(DEFAULT_ID_THEME.toString()))
    ...
    public void updateTheme() throws Exception {
        ...
        Theme testTheme = themeList.get(themeList.size() - 1);
        assertThat(testTheme.getIdTheme()).isEqualTo(UPDATED_ID_THEME);
