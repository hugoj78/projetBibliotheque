...
public class LivreResourceIT {
    ...
    private static final UUID DEFAULT_ID_LIVRE = UUID.randomUUID();
    private static final UUID UPDATED_ID_LIVRE = UUID.randomUUID();
    ...
    public void createLivre() throws Exception {
        ...
        assertThat(testLivre.getIdLivre()).isEqualTo(DEFAULT_ID_LIVRE);
    ...
    @Test
    @Transactional
    public void checkIdLivreIsRequired() throws Exception {
    ...
    public void getAllLivres() throws Exception {
        ...
        restLivreMockMvc.perform(get("/api/livres?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].idLivre").value(hasItem(DEFAULT_ID_LIVRE.toString())))
    ...
    public void getLivre() throws Exception {
        ...
        restLivreMockMvc.perform(get("/api/livres/{id}", livre.getId()))
            ...
            .andExpect(jsonPath("$.idLivre").value(DEFAULT_ID_LIVRE.toString()))
    ...
    public void updateLivre() throws Exception {
        ...
        Livre testLivre = livreList.get(livreList.size() - 1);
        assertThat(testLivre.getIdLivre()).isEqualTo(UPDATED_ID_LIVRE);
