...
public class EmplacementResourceIT {
    ...
    private static final UUID DEFAULT_ID_EMPLACEMENT = UUID.randomUUID();
    private static final UUID UPDATED_ID_EMPLACEMENT = UUID.randomUUID();
    ...
    public static Emplacement createEntity(EntityManager em) {
        Emplacement emplacement = new Emplacement()
            .idEmplacement(DEFAULT_ID_EMPLACEMENT)
    ...
    public static Emplacement createUpdatedEntity(EntityManager em) {
        Emplacement emplacement = new Emplacement()
            .idEmplacement(UPDATED_ID_EMPLACEMENT)
    ...
    public void createEmplacement() throws Exception {
        ...
        assertThat(testEmplacement.getIdEmplacement()).isEqualTo(DEFAULT_ID_EMPLACEMENT);
    ...
    @Test
    @Transactional
    public void checkIdEmplacementIsRequired() throws Exception {
        int databaseSizeBeforeTest = emplacementRepository.findAll().size();
        // set the field null
        emplacement.setIdEmplacement(null);
    ...
    public void getAllEmplacements() throws Exception {
        ...
        restEmplacementMockMvc.perform(get("/api/emplacements?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].idEmplacement").value(hasItem(DEFAULT_ID_EMPLACEMENT.toString())))
    ...
    public void getEmplacement() throws Exception {
        ...
        restEmplacementMockMvc.perform(get("/api/emplacements/{id}", emplacement.getId()))
            ...
            .andExpect(jsonPath("$.idEmplacement").value(DEFAULT_ID_EMPLACEMENT.toString()))
    ...
    public void updateEmplacement() throws Exception {
        ...
        Emplacement testEmplacement = emplacementList.get(emplacementList.size() - 1);
        assertThat(testEmplacement.getIdEmplacement()).isEqualTo(UPDATED_ID_EMPLACEMENT);
